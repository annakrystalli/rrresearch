...
### Create new project `gapminder-rmarkdown`!!


<div class="alert alert-info"><strong>File > New Project... > New Directory > New Project > gapminder-rmarkdown </strong></div>
...
```{r, eval=FALSE}
install.packages(c("ggplot2", "skimr", "dplyr", "plotly", "DT", "kableExtra"))
```
...
<img src="assets/knit.png" height="700px" width="800px"/>
...
You can quickly insert You can insert an [R code chunk](https://bookdown.org/yihui/rmarkdown/r-code.html) with:
...
- OPTIONAL Can you adapt the model and plotting code to use log10 transformed data?
...
- [`gapminder-analysis` Rendered html](http://annakrystalli.me/gapminder-analysis/)


- [`gapminder-analysis` Rmd](https://github.com/annakrystalli/gapminder-analysis/blob/master/index.Rmd)
